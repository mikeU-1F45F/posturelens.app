...
*/
  ...
  function O(a, b) {
    ...
    Object.defineProperties(a, { B: { value: b, configurable: !0, writable: !0, enumerable: !1 } })
    return b
  }
  function Jb(a, b) {
    var c = P(a)
  ...
  function cc(a, b, c, d, e) {
    ...
    if (!f) {
      ...
      b = m ? b & -9 : b | 8
      k != b &&
        ((m = h), Object.isFrozen(m) && (m = Array.prototype.slice.call(m)), Q(m, b), (h = m))
      l !== h && U(a, c, h)
      ;(e || (d && g)) && O(f, 2)
      d && Object.freeze(f)
      return f
  ...
  function Cc(a, b) {
    ...
    return Array.isArray(c) && (Dc in c || Ec in c || (0 < c.length && 'function' == typeof c[0]))
      ? c
      : void 0
  }
    ...
    return D(function (p) {
      switch (p.h) {
        case 1:
          ...
          b =
            void 0 === a.h.files ? [] : 'function' === typeof a.h.files ? a.h.files(a.l) : a.h.files
          return C(p, Qd(), 2)
        case 2:
          c = p.i
          if ('object' === typeof window)
            return (
              ...
              Od('createMediapipeSolutionsPackedAssets', { locateFile: a.locateFile }),
        ...
        case 2:
          ...
          if ('detection_list' === r.type) {
            if (p) {
              var E = p.getRectList()
              for (
                var M = p.getLandmarksList(), K = p.getClassificationsList(), u = [], F = 0;
                F < E.size();
                ++F
              ) {
                var ba = rd(E.get(F)),
                ...
                Ma = void 0 === Ma ? 0 : Ma
                ba = {
                  la: { ra: $d, sa: ae, height: be, width: ce, rotation: de, pa: gc(S(ba, 6), Ma) },
                  ea: Hd(M.get(F)),
                  ba: Fd(gd(K.get(F))),
                }
                u.push(ba)
    ...
    return D(function (e) {
      return 'number' === typeof c || c instanceof Uint8Array || c instanceof a.i.Uint8BlobList
        ...
        : c instanceof a.i.Texture2dDataOut
          ? ((d = a.v[b]), d || ((d = new Id(a.i, a.K)), (a.v[b] = d)), e.return(Jd(d, c, a.M)))
          : e.return(void 0)
    })
  }
  function Vd(a, b) {
      ...
      listeners: [
        {
          ...
          outs: {
            ...
            leftHandLandmarks: { type: 'proto', stream: 'left_hand_landmarks', transform: Hd },
            rightHandLandmarks: { type: 'proto', stream: 'right_hand_landmarks', transform: Hd },
            faceLandmarks: { type: 'proto', stream: 'face_landmarks', transform: Hd },
            poseLandmarks: { type: 'proto', stream: 'pose_landmarks', transform: Hd },
            za: { type: 'proto', stream: 'world_landmarks', transform: Hd },
            segmentationMask: { type: 'texture', stream: 'segmentation_mask' },
            multiFaceGeometry: { type: 'proto_list', stream: 'multi_face_geometry', transform: Zd },
          },
        },
      ],
      options: {
